      ...
      <div className="relative mx-auto mt-6 mb-10 max-w-7xl z-1">
        ...
        <div className="flex flex-col lg:flex-row mb-10 lg:mb-16 max-w-screen lg:max-w-5xl lg:mx-auto px-8 lg:px-0">
          ...
          <div className="w-full">
            ...
            >
              RemoteSquid, la agencia web estona con mentalidad española
            </h3>
            <p
              className={`${inter.className} mt-1 text-base lg:text-lg font-light text-rsq-900`}
            >
              Somos una agencia web, fundada en el 2020, por dos freelancers de
              la generación X con un buen background y experiencia decenal en
              programación y Marketing Digital. Somos motivad@s, felices de
              aprender cada día, abiert@s a nuevos retos y dispuest@s a luchar
              para quedarnos vivos en este mar digital. Palabra de 🦑.
            </p>
        ...
        <div className="flex flex-col lg:flex-row mb-10 lg:mb-16 max-w-screen lg:max-w-4xl mx-6 lg:ml-16 lg:mr-auto text-right">
          <div>
            ...
            <p
              className={`${inter.className} mt-1 text-base lg:text-lg font-light text-rsq-900`}
            >
              Codigo, nuevas tecnologias y estrategia digital están en su ADN.
              Perfecto aliado digital y disponible 24h por sus clientes.
              Creativo, rompedor y siempre atento a los nuevos trends del
              mercado digital. Soy Salva, ¿como puedo agilizar tu vida digital?
            </p>
        ...
        <div className="flex flex-col lg:flex-row max-w-screen lg:max-w-4xl px-8 lg:px-0 lg:mb-16 ml-auto">
          ...
          <div>
            ...
            <p
              className={`${inter.className} mt-1 text-base lg:text-lg font-light text-rsq-900`}
            >
              Meticulosa, profesional y directa al grano. Es una referente para
              los clientes de la agencia. Con su background en Turismo, todos
              sus contenidos hablan un idioma perfecto, sin fallos y sobretodo
              sin GPT. Es una lover de los colores, del progreso y del
              medio-ambiente.
            </p>
            <div className="relative flex flex-col lg:flex-row justify-start items-start lg:items-center gap-y-1 lg:gap-x-8 mt-2">
              {/* <div className="flex flex-row justify-center items-start">
