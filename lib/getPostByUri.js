...
export async function getPostByUri(uriString) {
    try {
        ...
        const resPostObj = {
            ...
            pFeatImgUri: apiPost.featuredImage?.node?.sourceUrl,
            pFeatImgSeoUrl: apiPost.featuredImage?.node?.seo?.canonicalUrl,
            pFeatImgSeoTitle: apiPost.featuredImage?.node?.seo?.title,
            pFeatImgSeoDescr: apiPost.featuredImage?.node?.seo?.description,
            pFeatImgSeoKw: apiPost.featuredImage?.node?.seo?.focusKeywords,
        };
